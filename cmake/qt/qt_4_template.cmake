ExternalProject_Add ( Qt_4_${VFXRP_EP_QT_VERSION_MINOR}_${VFXRP_EP_QT_VERSION_PATCH}
  URL
  file:///sw/external/install/qt/qt-everywhere-opensource-src-4.${VFXRP_EP_QT_VERSION_MINOR}.${VFXRP_EP_QT_VERSION_PATCH}.tar.gz
  ...
  BUILD_COMMAND env LD_LIBRARY_PATH=<SOURCE_DIR>/lib:$LD_LIBRARY_PATH make -j${VFXRP_NUM_PROCESSORS} install
  BUILD_IN_SOURCE 1
  )
